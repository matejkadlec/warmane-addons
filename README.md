...
- Completion detection handles known multi-step finales, including revived bosses, paired final bosses, and RDF completion rewards for scripted non-kill endings.
